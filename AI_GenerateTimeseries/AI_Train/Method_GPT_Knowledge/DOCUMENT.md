...
### Build
```bash
python AI_GenerateImage/AI_Train/Method_GPT_Knowledge/build_knowledge.py --config AI_GenerateImage/AI_Train/Method_GPT_Knowledge/config_build.json
```

### Generate
```bash
python AI_GenerateImage/AI_Train/Method_GPT_Knowledge/generate_gpt_knowledge.py --config AI_GenerateImage/AI_Train/Method_GPT_Knowledge/config_generate.json
```

### Validate
```bash
python AI_GenerateImage/AI_Train/Method_GPT_Knowledge/validate_gpt_knowledge.py --config AI_GenerateImage/AI_Train/Method_GPT_Knowledge/config_validate.json
```
