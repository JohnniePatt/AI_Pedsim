...
`Method_GridSocialPolicy` is the first grid-based behavior-cloning baseline for `AI_GenerateTimeseries`.
...
```text
AI_GenerateTimeseries/AI_Train/Method_GridSocialPolicy/model_grid_policy.py
```
...
```text
AI_GenerateTimeseries/AI_Train/Method_GridSocialPolicy/action_space.py
```
...
```text
AI_GenerateTimeseries/AI_Train/Method_GridSocialPolicy/train_grid_policy.py
```
...
```text
AI_GenerateTimeseries/AI_Result/Method_GridSocialPolicy/
```
