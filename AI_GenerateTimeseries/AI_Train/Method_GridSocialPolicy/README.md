...
`GridSocialPolicyNet` is the first trainable baseline for `AI_GenerateTimeseries`.
...
```bash
cd /home/johnfaqpc/programming/AI_Pedsim/AI_GenerateTimeseries/AI_Train/Method_GridSocialPolicy
...
```text
AI_GenerateTimeseries/AI_Result/Method_GridSocialPolicy/run_YYYYMMDD_HHMMSS/
  action_space.json
  config_train.json
  metrics.csv
...
/home/johnfaqpc/programming/AI_Pedsim-env/bin/python3 rollout.py \
  --checkpoint /home/johnfaqpc/programming/AI_Pedsim/AI_GenerateTimeseries/AI_Result/Method_GridSocialPolicy/<run>/checkpoints/best.pt \
  --input-dir /home/johnfaqpc/programming/AI_Pedsim/Dataset/Data_TrajectoryGrid/Topo_HouseGAN/A/train/<plan>/<sqlite_stem> \
  --output-dir /home/johnfaqpc/programming/AI_Pedsim/AI_GenerateTimeseries/AI_Result/Method_GridSocialPolicy/<run>/rollout_sample
```
...
/home/johnfaqpc/programming/AI_Pedsim-env/bin/python3 rollout_batch.py \
  ...
  --output-root /home/johnfaqpc/programming/AI_Pedsim/AI_GenerateTimeseries/AI_Result/Method_GridSocialPolicy/<run>/rollouts \
  --split val \
  --sample-count 10
```
