...
class TrainingConfiguration:
    ...
    RUNS_ROOT = PROJECT_ROOT / "AI_Result" / "Method_LSTM_SF_01" / "outputs"
...
def execute_training():
    raise RuntimeError(
        "Legacy Topo_bottleneck trainer is disabled in Method_LSTM_SF_01; use run_pipeline.py, "
        "which invokes the canonical synchronized joint-SF trainer."
    )
