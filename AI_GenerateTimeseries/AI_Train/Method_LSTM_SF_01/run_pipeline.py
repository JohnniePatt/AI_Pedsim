...
def main() -> None:
    cli = parser("Plan, train, or evaluate Method_LSTM_SF_01.")
    cli.add_argument("--config-train", type=pathlib.Path, default=HERE / "config_active.json")
    ...
    print(f"[pipeline] method=Method_LSTM_SF_01 stage={args.stage} outputs={outputs}")
