...
OUTPUT_DIR = PROJECT_ROOT / "AI_Result" / "Method_LSTM_SF_01" / "outputs" / "Topo2"
...
def main():
    raise RuntimeError(
        "Legacy Topo_bottleneck training is disabled inside Method_LSTM_SF_01; "
        "implement the canonical HouseGAN Social-Force pipeline first."
    )
