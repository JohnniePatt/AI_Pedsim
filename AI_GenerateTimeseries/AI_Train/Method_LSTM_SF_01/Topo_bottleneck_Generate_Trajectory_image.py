...
GEN_PATH_DIR = PROJECT_ROOT / "AI_Result" / "Method_LSTM_SF_01" / "outputs" / "Topo2" / "generated_paths"
IMG_OUTPUT_DIR = PROJECT_ROOT / "AI_Result" / "Method_LSTM_SF_01" / "outputs" / "Topo2" / "generated_images"
