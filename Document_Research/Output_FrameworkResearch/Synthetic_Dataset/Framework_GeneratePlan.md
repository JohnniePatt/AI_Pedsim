# Framework: Layout Generation (HouseGAN)

แผนผังด้านล่างแสดงลำดับขั้นตอนการทำงาน (Workflow) ของการสร้างแปลนแบบ Procedural โดยอ้างอิงจากโค้ด `generate_layout.py` และคอนฟิกใน `config_housegan.json` ครับ
