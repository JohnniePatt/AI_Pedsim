...
output_dir = PROJECT_ROOT / "AI_GenerateImage/AI_Result/Failure_Case_Analysis"
...
def run_inference():
    commands = [
        ...
        },
        {
            ...
            "pred_dir": "/home/johnnie/programming/AI_Pedsim/AI_Pedsim/AI_GenerateImage/AI_Result/Method_CVAE/outputs/run_CVAE_20260627_193237_config2/test_results/best_mae/predictions"
        }
    ]
