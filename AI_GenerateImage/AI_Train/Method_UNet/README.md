...
```bash
python AI_GenerateImage/AI_Train/Method_UNet/train_unet_trajectory_mask.py --config AI_GenerateImage/AI_Train/Method_UNet/config_train.json
```

Outputs are written to:

```text
AI_GenerateImage/AI_Result/Method_UNet/outputs/run_UNet_<timestamp>/
```
...
```bash
python AI_GenerateImage/AI_Train/Method_UNet/test_unet_trajectory_mask.py --run_path AI_GenerateImage/AI_Result/Method_UNet/outputs/<run_name>
```
