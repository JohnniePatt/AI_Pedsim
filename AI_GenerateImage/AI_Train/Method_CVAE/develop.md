...
.venv_sim/bin/python \
  AI_GenerateImage/AI_Train/Method_CVAE/train_CVAE_densitymap_bw.py \
  --config AI_GenerateImage/AI_Train/Method_CVAE/config_train_densitymap_bw_v3.json
```
...
.venv_sim/bin/python -m py_compile \
  AI_GenerateImage/AI_Train/Method_CVAE/cvae_model.py \
  AI_GenerateImage/AI_Train/Method_CVAE/cvae_losses.py \
  AI_GenerateImage/AI_Train/Method_CVAE/cvae_density_train.py \
  AI_GenerateImage/AI_Train/Method_CVAE/cvae_config.py
```
