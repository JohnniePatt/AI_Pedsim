...
```bash
python AI_GenerateImage/AI_Train/Method_CVAE/train_CVAE_densitymap_color.py --config AI_GenerateImage/AI_Train/Method_CVAE/config_train_densitymap_color.json
```

BW:

```bash
python AI_GenerateImage/AI_Train/Method_CVAE/train_CVAE_densitymap_bw.py --config AI_GenerateImage/AI_Train/Method_CVAE/config_train_densitymap_bw.json
```

BW v3 recovery experiment:

```bash
python AI_GenerateImage/AI_Train/Method_CVAE/train_CVAE_densitymap_bw.py --config AI_GenerateImage/AI_Train/Method_CVAE/config_train_densitymap_bw_v3.json
```
...
```bash
python AI_GenerateImage/AI_Train/Method_CVAE/test_CVAE_densitymap_color.py --run_path AI_GenerateImage/AI_Result/Method_CVAE/outputs/<run_name> --config AI_GenerateImage/AI_Train/Method_CVAE/config_test_densitymap_color.json
```

BW:

```bash
python AI_GenerateImage/AI_Train/Method_CVAE/test_CVAE_densitymap_bw.py --run_path AI_GenerateImage/AI_Result/Method_CVAE/outputs/<run_name> --config AI_GenerateImage/AI_Train/Method_CVAE/config_test_densitymap_bw.json
```
...
```bash
python AI_GenerateImage/AI_Train/Method_CVAE/test_CVAE_densitymap_bw.py --run_path AI_GenerateImage/AI_Result/Method_CVAE/outputs/<run_name> --num_samples 4
```

## Output Structure

```text
AI_GenerateImage/AI_Result/Method_CVAE/outputs/<run_name>/
checkpoints/best.pt
