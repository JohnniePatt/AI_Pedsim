...
commands = [
    ...
    #     "cmd": ["/home/johnnie/programming/AI_Pedsim/AI_Pedsim-env/bin/python3", "test_pix2pixhd_NoD_densitymap_bw.py", "--run_path", "/home/johnnie/programming/AI_Pedsim/AI_Pedsim/AI_GenerateImage/AI_Result/Method_pix2pixhd_No_D/outputs/run_HD_NoD_20260709_180550", "--config", "config_test.json"]
    # },
    # {
    #     "name": "CVAE",
    #     "dir": "Method_CVAE",
    #     "cmd": ["/home/johnnie/programming/AI_Pedsim/AI_Pedsim-env/bin/python3", "test_CVAE_densitymap_bw.py", "--run_path", "/home/johnnie/programming/AI_Pedsim/AI_Pedsim/AI_GenerateImage/AI_Result/Method_CVAE/outputs/run_CVAE_20260627_193237_config2"]
    # }
]
...
for c in commands:
    ...
    work_dir = PROJECT_ROOT / "AI_GenerateImage" / "AI_Train" / c["dir"]
